...
# print("Top-level keys:", list(capec_data.keys()))
# # Imprimir alguns documentos de cada coleção para verificação
# for collection_name in ['attack_patterns', 'categories', 'views', 'external_references']:
